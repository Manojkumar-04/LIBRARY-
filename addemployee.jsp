...
.centered {
  ...
  <meta charset="UTF-8">
  <title>Let's learn Add Employee</title>
  ...
  <section class="home">
    <div class="centered">
        <div class="login-container">
         <a href="addemp" class="" target="_top" style="color: darkpink;"> 𝒍𝒆𝒕'𝒔 𝒍𝒆𝒂𝒓𝒏 ! 𝑨𝒅𝒅 𝑬𝒎𝒑𝒍𝒐𝒚𝒆𝒆
   <img src="/images/book.png" width="20px" height="20" /><br>
</a>
    <form class="login-form" action="addemployee" method="post">
